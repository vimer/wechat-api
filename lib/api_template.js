...
exports._getIndustry = function (callback) {
  var apiUrl = this.prefix + 'template/get_industry?access_token=' + this.token.accessToken;
...
exports._getAllPrivateTemplate = function (callback) {
  var apiUrl = this.prefix + 'template/get_all_private_template?access_token=' + this.token.accessToken;
  this.request(apiUrl, {dataType: 'json'}, wrapper(callback));
};
...
exports._delPrivateTemplate = function (templateId, callback) {
  var apiUrl = this.prefix + 'template/del_private_template?access_token=' + this.token.accessToken;
  var data = {
...
exports.sendTemplate2 = function (openid, token, templateId, url, topColor, data, callback) {
  this.preRequest(this._sendTemplate2, arguments);
};

exports._sendTemplate2 = function (openid, token, templateId, url, topColor, data, callback) {
  var apiUrl = this.prefix + 'message/template/send?access_token=' + token;
