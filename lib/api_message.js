 ...
 */
exports.transferCustomerService = function (openid, callback) {
  this.preRequest(this._transferCustomerService, arguments);
};
...
exports.sendText2 = function(openid, text, token, callback) {
  this.preRequest(this._sendText2, arguments);
};

exports._transferCustomerService = function (openid, callback) {
 ...
 * 客服消息，发送文字消息的未封装版本
 */
exports._sendText2 = function (openid, text, token, callback) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"text",
  //  "text": {
  ...
  //  }
  // }
  var url = this.prefix + 'message/custom/send?access_token=' + (token || this.token.accessToken);
  console.log(url);
  //console.log(this.token.accessToken);
  var data = {
    "touser": openid,
